...
IMAGE_ROOT = '/home1/huangqiangHD/dataset/PANDA/'
OUT_PERSON_PATH = './user_data/split_person_train/'
OUT_VEHICLE_PATH = './user_data/split_vehicle_train/'
COCO_FORMAT_JSON_PATH = './user_data/coco_format_json'
